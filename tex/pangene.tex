...
pre-built pangene graphs can be downloaded from \href{https://zenodo.org/records/10038994}{https://zenodo.org/records/10038994}
...
PGGB~\citep{Garrison2023.04.05.535718} collapses paralogous genes which makes it difficult to study individual paralog.
...
Given perfect gene annotation and orthology relationship between the genes, the pangene graph construction algorithm is conceptually simple:
...
Further dropped about 2,000 single-coding-exon genes led to a graph containing 163 bibubbles.
...
\emph{PRH1} and \emph{GSTM1} are in relatively simple regions and look like real PAVs.
...
Overall, almost all human genes or their close paralogs were present in the majority of human haplotypes.
...
Involving outgroup species may hurt the the finding of localized bibubbles.
...
Pangene constructs a graph to joinly represent the gene content of multiple high-quality genomes.
...
How to efficiently identify generallized bibubbles remains an open and critical problem.
