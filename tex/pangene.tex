...
\author[2,4]{Maha Reda Farhat\ORCID{0000-0002-3871-5760}}
...
\address[4]{Pulmonary and Critical Care Medicine, Massachusetts General Hospital, Boston, USA}
...
It additionally finds subgraphs, which we call bibubbles, that capture gene content changes.
...
Source code at \url{https://github.com/lh3/pangene};
...
they have not been rigorously defined on bidirected graphs that assemblers and pangenome constructors output.
How to define and to find ``bubbles'' in bidirected graphs will also be a major topic of this article.
...
\begin{figure*}[b!]
\centering
\includegraphics[width=\textwidth]{MAPT}
...
\begin{figure}[t!]
\centering
\includegraphics[width=.49\textwidth]{fig7}
