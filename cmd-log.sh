...
ls *.fa.gz | sed s,.fa.gz,, | xargs -i echo miniprot --outs=0.97 --no-cs -Iut16 {}.fa.gz ../HUMAN-one.faa.gz \| gzip \> {}.paf.gz|asub -j run-mp -M36 -n16
../pangene -I@huamn.incl -X@human.excl aln-human/[14]*.paf.gz 2> human100.gfa.log | gzip > human100.gfa.gz
